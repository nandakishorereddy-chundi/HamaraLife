...
<head>
	...
	<link rel="stylesheet" href="assets/css/weekcss.css">
...
<div class="page-container"><!-- add class "sidebar-collapsed" to close sidebar by default, "chat-visible" to make chat appear always -->
	...
	<td align="center" valign="top" style="padding-top: 20px; background: url(../images/header/body-bg.jpg) repeat-x top;">
        <table width="963" border="0" cellspacing="0" cellpadding="0">
                ...
                <tr>
                    <td align="right" style="color: cornflowerblue;" valign="top">
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" style="margin-left:+100px;color:#848484;">
                            <tbody><tr><br><br>
                                <td>&nbsp;
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Select State :
                                    <select name="ctl00$MainContent$ddlStates" onchange="javascript:setTimeout('__doPostBack(\'ctl00$MainContent$ddlStates\',\'\')', 0)" id="ctl00_MainContent_ddlStates">
                            ...
                            <tr>
                                <td colspan="4" align="left" valign="middle">
                                    <div><br><br>
										...
										<tbody>
											<tr>
												<th colspan="1"  bgcolor="#2987c0" height="19" width="2%" align="center">S.No</th><th colspan="1"  bgcolor="#2987c0" height="19" width="5%" align="center">MEETING VENUE</th><th colspan="1"  bgcolor="#2987c0" height="19" width="3%" align="center">CITY</th><th colspan="1"  bgcolor="#2987c0" height="19" width="3%" align="center">STATE</th><th colspan="1"  bgcolor="#2987c0" height="19" width="3%" align="center">WEEKDAYS</th><th colspan="1"  bgcolor="#2987c0" height="19" width="3%" align="center">TIME</th><th colspan="1"  bgcolor="#2987c0" height="19" width="5%" align="center">CONTACT PERSON</th><th colspan="1"  bgcolor="#2987c0" height="19" width="5%" align="center">CONTACT NO</th>
											</tr>
											<tr>
											<td>1</td><td>Jubliee Hotel</td><td>Hyderabad</td><td>Telangana</td><td>1</td><td>12:30PM</td><td>JAGAN</td><td>0000000000</td>
											</tr>
											<tr>
											<td>2</td><td>Varun Towers</td><td>Vijayawada</td><td>AndhraPradesh</td><td>3</td><td>1:00PM</td><td>SRINIVAS</td><td>0000000000</td>
											</tr>
											</tbody>
										</table>
