...
<div class="login-container">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<form class="form-1" name="myform" method="POST" action="checking.php" onsubmit="return validateForm();">
				...
				<div>
				<div class="form-group">
                        <button type="submit" class="btn btn-default btn-lg btn-block btn-icon icon-left twitter-button">
