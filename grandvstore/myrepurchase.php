	...
	<div class="main-content">
		...
		<hr /><!-- start -->
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tbody>
										<tr>
											<h1>My Re-Purchase Value</h1>
										</tr>
									</tbody>
								</table><br>								
					
					<div style="border-style: solid;border-width: 1px;border-radius:20px;border-color:#01A9DB;"><br>
					<h3 style="margin-left:+100px;color:#848484;">Please Select Date Of Purchase To Display Your Products:</h3>
						<br><br>
		...
		<h3 style="margin-left:+100px;color:#848484;">You Can Also Use Your Re-Purchase points As Below:</h3>
					<br><br>
					<div class="form-group" style="padding-left: 130px;">
						<form>
							<input type="radio" name="value" value="100-500" checked> 0-100
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="value" value="100-500" checked> 100-200
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="value" value="100-500" checked> 200-300
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="value" value="100-500" checked> 300-400
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="value" value="100-500" checked> 400-500
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="radio" name="value" value="100-500" checked> 500+
